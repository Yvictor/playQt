...
from PySide2.QtCore import QAbstractTableModel, QModelIndex, QRect, Qt, QThread, Signal
...
class TableWidget(QWidget):
    def __init__(self):
        ...
        #self.connect(self.thread_quote, SIGNAL("TEST"), self.random_update)
    
    def random_update(self):
        #print('test')
        self.model.random_data()

class ThreadQuote(QThread):
    test = Signal()
    def __init__(self, parent=None):
        super(ThreadQuote, self).__init__(parent)
